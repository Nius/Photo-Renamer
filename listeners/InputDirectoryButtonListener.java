 ...
 */
public class InputDirectoryButtonListener implements ActionListener
{
	 ...
	 */
	public InputDirectoryButtonListener(Container parentPanel, Engine engine)
	{
		super();
		ENGINE = engine;
	...
	private void checkResult(int result, PointerBuffer path)
	{
        switch (result)
        {
            case NFD_OKAY:
        		...
        		ENGINE.updateInputDirectory(selectedFile);
